package com.longder.trace.configuration;


import com.longder.trace.security.CustomerUserDetailsService;
import com.longder.trace.security.FormLoginSuccessHandler;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                // 卖方后台url权限控制
                .antMatchers("/admin/**").hasAnyRole( "SELLER")
                .and()
